<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuthorManager2.aspx.vb" Inherits="ADO.NET.AuthorManager2"%>
...
<asp:Button id=cmdInsert runat="server" Width="85px" Height="24px" Text="Insert New"></asp:Button></P></asp:panel><BR>
...
<asp:Label id=lblStatus runat="server" Width="575px" Height="121px" Font-Bold="True"></asp:Label></P></asp:panel><br></FORM>
