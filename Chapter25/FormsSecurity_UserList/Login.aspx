<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Login.aspx.vb" Inherits="FormsSecurity_UserList.Login"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			&nbsp;
			<asp:Label id="Label3" style="Z-INDEX: 107; LEFT: 24px; POSITION: absolute; TOP: 264px" runat="server" Width="376px" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small">Acounts are Matthew/secret (an administrator) and Sarah/opensesame (a normal user).</asp:Label>
		</form>
	</body>
</HTML>
