...
Namespace localhost
    ...
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="SecuredServiceSoap", [Namespace]:="http://tempuri.org/")>  _
    Public Class SecuredService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://localhost/ASP.NET/Chapter25/SecureService/SecuredService.asmx"
        End Sub
        ...
        Public Function TestAuthenticated() As String
            Dim results() As Object = Me.Invoke("TestAuthenticated", New Object(-1) {})
        ...
        Public Function BeginTestAuthenticated(ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("TestAuthenticated", New Object(-1) {}, callback, asyncState)
        End Function
